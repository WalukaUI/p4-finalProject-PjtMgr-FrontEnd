...
function EmployeesOftheCity({ depts, cities, activate, setActivate }) {
  ...
  return (
    <>
      ...
      >
        Employees of the{" "}
        {cities.map((c) => (c.id === parseInt(params.id) ? c.name : null))}
        (City)
      </h4>
      {empofCity !== null ? (
              ...
              >
                ...
                <div className="card-body text-secondary">
                  ...
                  <p className="card-text">
                    Department:{" "}
                    {depts.map((d) =>
                      d.id === emp.department_id ? d.name : null
                    )}
                  </p>
                  <div>
                    <Link
